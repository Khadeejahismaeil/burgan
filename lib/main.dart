...
//             const Center(
//               child: Text(
//                 "Add a brief description under the logo, summarizing Burgan Banks services",
...
// }
import 'package:flutter/material.dart';
import 'list.dart'; // Ensure list.dart contains the ListScreen widget
...
class _SplashScreenState extends State<SplashScreen> {
  double _opacity = 0.0; // Initial opacity for the splash screen elements
      ...
      body: Center(
        child: AnimatedOpacity(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                "assets/images/download.png", // Your splash image
                height: 100,
              ),
              const SizedBox(height: 20),
              const Text(
